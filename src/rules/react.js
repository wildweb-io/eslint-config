module.exports = {
	reactRules: {
		...
		'react/jsx-closing-bracket-location': [0, {nonEmpty: 'tag-aligned', selfClosing: false}],
		'react/jsx-closing-tag-location': [0],
		'react/jsx-curly-brace-presence': [2, {props: 'never', children: 'ignore', propElementValues: 'always'}],
		'react/jsx-curly-newline': [0, {multiline: 'consistent', singleline: 'forbid'}],
		...
		'react/jsx-key': [2, {checkFragmentShorthand: true, checkKeyMustBeforeSpread: true, warnOnDuplicates: true}],
		...
		'react/jsx-no-target-blank': [2, {warnOnSpreadAttributes: true, forms: true, links: true}],
		'react/jsx-no-undef': [2],
		'react/jsx-no-useless-fragment': [2],
		'react/jsx-one-expression-per-line': [0, {allow: 'single-child'}],
		'react/jsx-pascal-case': [2, {allowAllCaps: true, ignore: []}],
		'react/jsx-props-no-multi-spaces': [2],
		'react/jsx-props-no-spreading': [0, {html: 'enforce', custom: 'enforce', explicitSpread: 'ignore', exceptions: []}],
		...
		'react/sort-prop-types': [0, {ignoreCase: true, callbacksLast: false, requiredFirst: false, sortShapeProp: true}],
